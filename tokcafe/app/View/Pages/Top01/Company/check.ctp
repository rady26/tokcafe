...
if(!CheckUtility::Required($nick_name)) {
	$nick_name_err = "Please input your person in charge";
	$flag = 1;
}
if(!CheckUtility::Required($url)) {
	$url_err = "Please input url of company my page";
	$flag = 1;
}
...
if(!CheckUtility::Required($founder)) {
	$founder_err = "Please input founder";
	$flag = 1;
}
if(!CheckUtility::Required($employees)) {
	$employees_err = "Please input number of employees";
	$flag = 1;
}
if(!CheckUtility::Required($month)) $month = "Month";
if(!CheckUtility::Required($year)) $year = "Year";
if(($month=="Month" && $year!="Year") || ($month=="Month" && $year=="Year")) { 
	$month = "Month";
	$date_err = "Please select month";
	$flag = 1;
}else {
	if($month!="Month" && $year=="Year") { 
		$year = "Year";
		$date_err = "Please select year";
		$flag = 1;
	}
}

if($industry_01=="Please select" && $industry_02=="Please select" && $industry_03=="Please select") {
	$industry_01="Please select";
	$industry_02="Please select";
	$industry_03="Please select";
	$industry_err = "Please select related industry";
	$flag = 1;
}
...
?>
<?php echo $this->Html->css('top_01/company/error','stylesheet', array('inline' => false ) ); ?>
						...
						<table class="table" cellpadding="0" cellspacing="0" >
							...
							<tr>
								...
								<td class="tdRight">
									...
									<p class="error"><?php echo $url_err; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
							...
							<tr>
								...
								<td class="tdRight">
									...
									?>
									<p class="error"><?php echo $founder_err; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
								...
								<td class="tdRight">
									...
									?>
									<p class="error"><?php echo $employees_err; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
							...
							<tr>
								...
								<td class="tdRight">
									...
									<p class="error"><?php echo $industry_err; ?></p>
								</td>
							</tr>
						</table>
...
if($flag!=1 && $industry_01=="Please select" && $industry_02!="Please select" && $industry_03!="Please select") {
	$industry_01="";
	$industry_02=$industry_02."<br />";
	$industry_03=$industry_03."<br />";
} else {
	if($flag!=1 && $industry_01=="Please select" && $industry_02!="Please select" && $industry_03=="Please select") {
		$industry_01="";
		$industry_02=$industry_02;
...
<?php echo $this->Html->css('top_01/company/confirm','stylesheet', array('inline' => false ) ); ?>
					...
					<div id="box">
						<table class="table" cellpadding="0" cellspacing="0" >
							...
							<tr>
								...
								<td class="tdRight">
									<p class="detail"><?php echo $web_site; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
								...
								<td class="tdRight">
									<p class="detail"><?php echo $founder; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
								...
								<td class="tdRight">
									<p class="detail"><?php echo $employees; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft">
								...
								<td class="tdRight">
									<p class="detail"><?php echo $month." ".$year; ?></p>
								</td>
							</tr>
							<tr>
								<td class="tdLeft ver-top">
								...
								<td class="tdRight">
									<p class="detail"><?php echo $industry_01." ".$industry_02." ".$industry_03; ?></p>
								</td>
							</tr>
						...
						<div class="confirm">
							...
							<?php echo $this->Form->submit("top_01/company/check/bt_register.png", array('class' => 'submit linkimg', 'name' => 'confirm')); ?>
						</div>
					</div>
				</form>
				<div class="direction">
					<?php echo $this->Html->image('top_01/company/check/img_step1.png', array('alt' => 'step 1')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_arrow.png', array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_step2.png', array('alt' => 'step 2')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_arrow.png', array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_step3.png', array('alt' => 'step 3')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_arrow.png', array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/company/check/img_step4.png', array('alt' => 'step 4')); ?>
				</div>
			</div>
		</div>
	</div>
