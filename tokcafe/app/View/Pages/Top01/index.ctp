...
if(!CheckUtility::Required($status)) $status = "Please select";
...
?>
<?php echo $this->Html->css('top_01/index','stylesheet', array('inline' => false ) ); ?>
					...
					<div id="box">
						<table class="table" cellpadding="0" cellspacing="0" >
							<tr>
								...
								<td class="tdRight">
									<?php echo $this->Form->input('txtUserName', 
										array('type' => 'text', 
										'id' => 'name', 
										'name' => 'name', 
										'class' => 'txtText', 
								...
								<td class="tdRight">
									<label class="control">
										<?php
											...
											echo $this->Form->input('selStatus', 
												array('type' => 'select', 
												'id' => 'status', 
												'name' => 'status', 
												'class' => 'select status', 
							...
							<tr>
								...
								<td class="tdRight">
									<?php echo $this->Form->input('txtTelephone', 
										array('type' => 'text', 
										'id' => 'phone', 
										'name' => 'phone', 
										'class' => 'txtText phone', 
							...
							<tr>
								...
								<td class="tdRight">
									<?php echo $this->Form->input('txtEmail', 
										array('type' => 'text', 
										'id' => 'mail', 
										'name' => 'mail', 
										'class' => 'txtText mail', 
