...
Except as set forth in the law, it does not provide and disclosure of personal information to third parties.</p>
				...
				<div id="box">
					...
					<p class="subDesc grid_01">Thank you for registering.</br>
We have an automatic reply to your email address. Please check.</p>
					<p class="notice"><span class="star">*</span>Do not need to log in from the mail.</p>
...
info@frsintl.com</p>
					<div class="confirm">
						<?php echo $this->Form->submit("top_01/complete/bt_start.png", array('class' => 'submit linkimg', 'name' => 'confirm')); ?>
					</div>
				</div>
				<div class="direction">
					<?php echo $this->Html->image('top_01/complete/img_step1.png',array('alt' => 'step 1')); ?>
					<?php echo $this->Html->image('top_01/complete/img_arrow.png',array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/complete/img_step2.png',array('alt' => 'step 2')); ?>
					<?php echo $this->Html->image('top_01/complete/img_arrow.png',array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/complete/img_step3.png',array('alt' => 'step 3')); ?>
					<?php echo $this->Html->image('top_01/complete/img_arrow.png',array('class' => 'arrowDown', 'alt' => 'Arrow Down')); ?>
					<?php echo $this->Html->image('top_01/complete/img_step4.png',array('alt' => 'step 4')); ?>
				</div>
			</div>
		</div>
	</div>